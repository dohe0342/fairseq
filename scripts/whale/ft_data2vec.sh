...
fairseq-hydra-train \
	...
	checkpoint.save_dir=/home/work/workspace/fairseq/scripts/whale/outputs/viewmaker_try6_0005 \
	job_logging_cfg.console.file.filename='viewmaker_try6_0005.log'
