...
class Trainer(object):
    ...
    def __init__(self, cfg: FairseqConfig, task, model, criterion, quantizer=None):
        ...
        print('---'*30)
        print(self.cfg.job_logging_cfg.handlers.file)
        print('---'*30)
    ...
    def _build_optimizer(self, pcgrad=False):
        ...
        for n, p in self.model.named_parameters():
            if 'viewmaker' not in n and 'feature_extractor' not in n and p.requires_grad:
                params_w2v.append(p)
    ...
    def load_checkpoint(
        ...
        if last_optim_state is not None and not reset_optimizer:
            ...
            self._build_optimizer(pcgrad=False)
            ...
            try:
                with maybe_no_sync():
                    ...
                    loss, sample_size_i, logging_output = self.task.train_step(
                        ...
                        optimizer=[self.optimizer, self.optimizer2] if epoch >= 2 else [self.optimizer2],
