...
class InferenceProcessor:
    ...
    def __init__(self, cfg: InferConfig) -> None:
        ...
        if 1:
            import fairseq
            del models
            models_hardloading, _, _ = fairseq.checkpoint_utils.load_model_ensemble_and_task(['/workspace/models/wav2vec_model/w2v_l_1gen.pt'], arg_overrides=saved_cfg, task=self.task)
