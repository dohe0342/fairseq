...
if __name__ == '__main__':
    ...
    parser.add_argument('--subset', default='train-100', help='cifar10 | imagenet')
    ...
    if args.dataset == 'LibriSpeech':
        ...
        models, temp4, temp5 = fairseq.checkpoint_utils.load_model_ensemble_and_task(['/home/work/workspace/models/wav2vec_model/wav2vec_small_10m.pt'])
    ...
    if len(d) == 2 and rank == args.root_rank:
    ...
    if rank == args.root_rank and args.dataset == 'cifar10':
    ...
    #--------------------------------------------------------------------------
    if args.dataset == 'LibriSpeech':
        crunch(surf_file, net, w, s, d, trainloader, 'train_loss', 'train_acc', comm, rank, args, cfg=cfg, task=task)
    else:
    ...
    # Plot figures
    #--------------------------------------------------------------------------
    if args.plot and rank == args.root_rank:
