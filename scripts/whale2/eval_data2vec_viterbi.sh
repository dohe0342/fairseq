...
do
	...
	then
		CUDA_VISIBLE_DEVICES=$2 python /home/work/workspace/fairseq_whale2/examples/speech_recognition/new/infer.py \
			--config-dir /home/work/workspace/fairseq_whale2/examples/hubert/config/decode \
		...
		CUDA_VISIBLE_DEVICES=$2 python /home/work/workspace/fairseq_whale2/examples/speech_recognition/new/infer.py \
			--config-dir /home/work/workspace/fairseq_whale2/examples/speech_recognition/new/conf \
			--config-name infer \
