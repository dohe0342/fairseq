...
class FairseqTask(object):
    ...
    def train_step(
            self, sample, model, criterion, optimizer, update_num, ignore_grad=False, uses_branch_v1=False, uses_branch_v2=False, uses_branch_v3=False, viewmaker=True, multiple_view=False
    ):
        """
        ...
        if uses_branch_v1:
            ...
            if len(optimizer) == 1:
                ...
                with torch.autograd.profiler.record_function("backward"):
                    ...
                    optimizer[0].backward(0.9999*loss[0][0]+0.0001*loss[0][1], retain_graph=True)
