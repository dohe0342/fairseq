...
class ViewMaker(BaseFairseqModel):
    ...
    def __init__(self, num_channels=512, distortion_budget=0.03, activation='gelu',
                clamp=True, frequency_domain=False, downsample_to=False, num_res_blocks=5, num_noise=5):
